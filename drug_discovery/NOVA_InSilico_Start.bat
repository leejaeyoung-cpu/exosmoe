@echo off
REM NOVA In Silico Validation System Launcher
REM Version 1.0

echo ========================================
echo  NOVA In Silico Validation System
...
echo [3/3] Starting NOVA In Silico Validation...
echo.
echo ========================================
...
REM Start Streamlit
streamlit run nova_insilico_validation_ui.py --server.port 8503
